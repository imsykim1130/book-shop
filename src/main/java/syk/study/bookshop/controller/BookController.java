...
public class BookController {
    ...
    @GetMapping("/books/t")
    public ResponseEntity<?> bookSearchByTitle(@RequestParam(name="title") String title) throws IOException {
    ...
    @GetMapping("/books/is")
    public ResponseEntity<?> bookSearchByIsbn(@RequestParam(name="isbn") String isbn) throws IOException {
        // naver api 에서 데이터 받아오기
